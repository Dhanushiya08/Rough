...
export default function Uploading({ goNext }: { goNext?: () => void }) {
  ...
  const uploadMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      setFileId(data.file_id); // ✅ set only after success
      setIsUploaded(true);     // ✅ mark uploaded
      setConfirm(false);
    },
  ...
  const isProcessing =
    processingMutation.isPending || uploadMutation.isPending;
    ...
    <div className="h-full flex items-center justify-center bg-[#F7F9FB]">
      ...
      <div className="w-[420px] bg-white rounded-md p-5 space-y-4 shadow-md relative">
        ...
        <CustomSelect
          ...
          disabled={!isUploaded || isProcessing} // ✅ FIXED
        />
